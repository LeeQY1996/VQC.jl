# raw_data(a::QCircuit) = a.operations
# const QCircuitData = Vector{QuantumCircuits.CircuitElement}
...
# function _is_commutative(a::QCircuitData, b::Gate)
#     for item in a
#         _is_commutative(item, b) || return false
#     end
#     return true
# end
# _is_commutative(a::QCircuit, b::Gate) = _is_commutative(raw_data(a), b)
...
#     end
#     r = _try_mul_two_ops_impl(ordered_positions(a), a_op, ordered_positions(b), b_op)
#     (r === nothing) && return nothing
#     k = (length(ordered_positions(a)) >= length(ordered_positions(b))) ? ordered_positions(a) : ordered_positions(b)
#     return QuantumGate(k, r)
# end

# function try_absorb_one_gate_by_mul!(a::QCircuitData, gate::Gate, workspace::AbstractVector)
...
# function try_absorb_by_mul_impl(a::QCircuitData, workspace::AbstractVector)
#     isempty(a) && return a
#     L = length(a)
#     b = copy(a)
#     for i in L:-1:2
...
# valid_data(data::QCircuitData) = all(x->isa(x, Gate), data)

# function fuse_gates(a::QCircuit)
#     valid_data(raw_data(a)) || throw(ArgumentError("QCircuit of pure gate operations expected"))
#     b = _fuse_gate_impl(a')
